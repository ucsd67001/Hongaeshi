...
const 直す表 = {
  ...
  // ⚠️ 「Ado 小松成美」は2人。国会図書館では「Ado 原作、小松成美 著」。機械には割れない。
  //    文章の書き手は小松成美、Ado は原作（語り手）。**連名**にして、書き手を先に置く（2026-09-25 持ち主の判断）。
  //    前は Ado だけにしていた
  "9784048976602": { 名ら:["小松成美", "Ado"], 表示:"小松成美 著／Ado 原作" },   // ビバリウム
